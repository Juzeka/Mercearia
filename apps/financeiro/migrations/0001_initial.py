...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('finalizada', models.BooleanField(auto_created=True, default=False, verbose_name='Finalizada')),
                ('criado_em', models.DateTimeField(auto_now_add=True, verbose_name='Criado em')),
                ('alterado_em', models.DateTimeField(auto_now=True, verbose_name='Alterado em')),
                ('forma_pagamento', models.CharField(choices=[('AB', 'Aberta'), ('DI', 'Dinheiro'), ('CD', 'Débito'), ('CC', 'Crédito')], default='AB', max_length=20)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fechado_em', models.DateTimeField(auto_now_add=True, verbose_name='Fechado em')),
